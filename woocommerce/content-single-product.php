...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class('', $product); ?>>
	<div class="container">
		<div class="top-product bd-radius-10 w-100 box-shadow-6 bg-white py-5 px-4  mt-4 mb-5 justify-content-md-between">
			<div class="row">
				<?php
				/**
				...
				<div class="col-lg-5 col-12">
					<div class="summary  entry-summary ps-4 w-100 ">
						<?php
						/**
